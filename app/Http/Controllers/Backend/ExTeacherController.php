...
class ExTeacherController extends Controller
{
    ...
    {
        $exTeachers = Teacher::where('teacher_status', 2)->get();
        return view('backend.ex_teacher.index', compact('exTeachers'));
    }
    ...
    public function exTeacherProfileSetting()
    {
        $profile = Auth::user()->load('teacherInfo');
        return view('frontend.profileSetting.exTeacherProfileSetting', compact('profile'));
    }

    public function exTeacherProfileStatus(Request $request, $id)
    {
    ...
    public function postProfileupdate(Request $request, $id)
    {
        ...
        $profile->save();
        return redirect()->route('ex.teacher.profile.setting')->with('success', 'Profile details updated !');
    ...
    public function postMyselfdupdate(Request $request, $id)
    {
        ...
        return redirect()->route('ex.teacher.profile.setting')->with('success', 'MySelf upadated successfully !');
    }
    ...
    public function postPasswordupdate(Request $request, $id)
    {
        ...
        return redirect()->route('ex.teacher.profile.setting')->with('success', 'User password have been changed successfully !');
    }

    public function getExTeacherProfile()
    {
        $profile = Auth::user()->load('teacherInfo');
        return view('frontend.profileSetting.singleExTeacherProfile', compact('profile'));
    }
}
