            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a href="{{route('students.index')}}">Teachers</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::model($user, ['method' => 'PUT', 'route' => ['students.update',  $user->id ] ]) !!}
                            <!-- Name Form Input -->
                            ...
                            <div class="form-group @if ($errors->has('student_status')) has-error @endif">
                                <select name="student_status" id="student_status" class="form-control">
                                    @foreach(config('studentStatus.reverse_status') as $key => $status)
                                        <option value="{{ $key }}" {{ $key == $user->studentStatus->student_status ? 'selected':'' }}>{{ $status }}</option>
                                    @endforeach
                                </select>
                            </div>
