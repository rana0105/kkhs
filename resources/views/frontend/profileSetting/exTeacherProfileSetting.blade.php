			    ...
			    <div class="col-md-8 right-profile-style">
			      <div class="tab-content" id="v-pills-tabContent">
			        <div class="tab-pane fade active show" id="v-pills-student-status" role="tabpanel" aria-labelledby="v-pills-student-status-tab">
		                ...
		                @endif
			          <form action="{{ route('ex.teacher.profile.status', $profile->id) }}" method="POST">
			          	{{ csrf_field() }}
			        ...
			        <div class="tab-pane fade" id="v-pills-userupdate" role="tabpanel" aria-labelledby="v-pills-userupdate-tab">
			          	<form action="{{ route('ex.teacher.profile.update', $profile->id) }}" method="POST">
			          		{{ csrf_field() }}
						  <div class="form-group row">
			        ...
			        <div class="tab-pane fade" id="v-pills-myself" role="tabpanel" aria-labelledby="v-pills-myself-tab">
			          	<form action="{{ route('ex.teacher.profile.myself', $profile->id) }}" method="POST" enctype="multipart/form-data" file="true">
			          		{{ csrf_field() }}
						  <div class="form-group row">
			        ...
			        <div class="tab-pane fade" id="v-pills-password" role="tabpanel" aria-labelledby="v-pills-password-tab">
			          <form action="{{ route('ex.teacher.profile.password', $profile->id) }}" method="POST">
			          	{{ csrf_field() }}
						  <div class="form-group row">
