			  ...
			  <div class="row">
			    <div class="col-md-3 left-profile-style">
			      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			        <a class="nav-link active show" id="v-pills-student-status-tab" data-toggle="pill" href="#v-pills-student-status" role="tab" aria-controls="v-pills-student-status" aria-selected="false">Teacher Status</a>
			      </div>
			    </div>
			    <div class="col-md-8 right-profile-style">
			      <div class="tab-content" id="v-pills-tabContent">
			        <div class="tab-pane fade active show" id="v-pills-student-status" role="tabpanel" aria-labelledby="v-pills-student-status-tab">
		                ...
		                @endif
			          <form action="{{ route('teacher.status.update', $profile->id) }}" method="POST">
			          	{{ csrf_field() }}
						  <div class="form-group row">
						    <label for="status" class="col-sm-3 col-form-label">Teacher Status</label>
						    <div class="col-sm-9">
